...
\begin{rtable}
 \begin{rsection}{Publications}
  ...
  \begin{rsection}{In Submission}    
    ...
    Arvind Krishnamurthy, Henry M. Levy. \textit{Diamond: Automating
      Data Management and Storage for Wide-area, Reactive Applications}\\\vspace{-0.5em}
    ...
    Luis Ceze. \textit{Disciplined Inconsistency.}\\\vspace{-0.5em} 
...
\begin{rtable}
  \begin{rsection}{Patents}
    ...
    \textit{Identification of Page Sharing Opportunities within Large
      Pages.}\\
    Y. Baskakov, A. Garthwaite, R. Venkatasubramanian, \textbf{I. Zhang}, S. Kim, N. Bhatia, K. Tati\\\vspace{-0.5em}
  \end{rsection}
